(function() {
  ...
  this.acquire_depth_first = function(source, cfg) {
    var descriptor, g, key, owner, ref, ref1, ref2, seen, target, y;
    ...
    for (y of ref1) {
      ...
      if (cfg.filter != null) {
        if (!cfg.filter({target, owner, key, descriptor})) {
          continue;
        }
      }
      if (seen.has(key)) {
