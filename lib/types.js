(function() {
  'use strict';
  var All_of, Any_of, Failure, Intertype, Isa, Iterator, Optional, Sentinel, _Intertype, _types, debug, defaults, get_value, nothing, props;
  ...
  _Intertype = class _Intertype {
    ...
    _verify(key, type, x, isa) {
      debug('^Intertype::_verify@1^', {
        key,
        type,
        x,
        isa,
        isa_optional: x === this._optional
      });
      if (x === this._optional) {
        return x.get();
      }
