  ...
  this.Types = Types = class Types {
    ...
    * _walk_keys_and_methods(x) {
    ...
    _compile(declarations) {
      var cfg, me, method, otype, ref, type, y;
      if (props == null) {
        props = require('./props');
      }
      this.isa = {};
      ...
      return null;
      ref = this._walk_keys_and_methods(declarations);
      //.......................................................................................................
      //.......................................................................................................
      //.......................................................................................................
      for (y of ref) {
        ...
        this.isa[type] = method;
        //.....................................................................................................
        ((type, otype, method) => {
          //...................................................................................................
          // isa_optional_$type
          this.isa[otype] = props.nameit(`isa_${otype}`, (x) => {
            return (x == null) || (method(x));
          });
          //...................................................................................................
          // validate_$type
          this.validate[type] = props.nameit(`validate_${type}`, (x) => {
            if (method(x)) {
              return x;
            }
          ...
          return this.validate[otype] = props.nameit(`validate_${otype}`, (x) => {
            if ((x == null) || (method(x))) {
              return x;
            }
