(function() {
  'use strict';
  var All_of, Any_of, Failure, Intertype, Isa, Iterator, Optional, Sentinel, _Intertype, debug, defaults, get_value, misfit, props;
  ...
  Sentinel = class Sentinel {
    ...
    get() {
      var R;
      if ((R = this.value) instanceof Sentinel) {
        return R.get();
      } else {
        return R;
      }
  ...
  //===========================================================================================================
  Optional = class Optional extends Sentinel {};

  Failure = class Failure extends Sentinel {};

  Iterator = class Iterator extends Sentinel {};
  ...
  _Intertype = class _Intertype {
    ...
    constructor(cfg) {
      ...
      props.hide(this, 'types_of', this.types_of.bind(this));
      return void 0;
    }
    ...
    _isa(type, x, isa) {
      ...
      if (x instanceof All_of) {
        ...
        if (x[Symbol.iterator] == null) {
          return true;
        }
/* TAINT use type */        for (element of x) {
...
/* TAINT use type */        for (element of x) {
    ...
    _validate(type, x) {
      ...
      throw new Error(`^_Intertype::_validate@1^ expected a ${type}, got a ${this.type_of(x)}`);
    }
    ...
    //---------------------------------------------------------------------------------------------------------
    types_of(x) {
      var R, i, isa_method, len, ref, type;
      R = new Set();
      ref = this._isa_methods;
      for (i = 0, len = ref.length; i < len; i++) {
        [type, isa_method] = ref[i];
    ...
    get_denicola_device_name(x) {
      var ref, ref1;
      return (ref = x != null ? (ref1 = x.constructor) != null ? ref1.name : void 0 : void 0) != null ? ref : '0';
    }
