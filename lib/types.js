(function() {
  'use strict';
  var Isa, Types, debug, isa_class, isa_function, props, rename_isa_methods;
  ...
  this.Types = Types = class Types {
    ...
    * _walk_keys_and_methods(x) {
    ...
    _create_declaration_proxy(declare) {
      ...
      return new Proxy(declare, {
        get: (target, key, receiver) => {
          ...
          debug('^_create_declaration_proxy/Proxy/get@1^', {key}, this.isa[key]);
    ...
    //---------------------------------------------------------------------------------------------------------
    _compile() {
      var method, otype, proto_isa, proto_vld, ref, type, y;
      ...
      proto_isa = {};
      proto_vld = {};
      this.isa = Object.create(proto_isa);
      this.validate = Object.create(proto_vld);
      this.declare = this._create_declaration_proxy({});
      props.hide(this, '_isa_methods', []);
      ref = this._walk_keys_and_methods(Isa);
      //.......................................................................................................
      for (y of ref) {
        [type, method] = y;
        ...
        ((type, otype, method) => {
          ...
          return proto_vld[otype] = props.nameit(`validate_${otype}`, (x) => {
            if ((x == null) || (method(x))) {
              return true;
            }
            throw new Error(`expected an ${otype} got a ${this.type_of(x)}`);
          });
        })(type, otype, method);
