(function() {
  ...
  this.Isa = Isa = class Isa {
    ...
    //---------------------------------------------------------------------------------------------------------
    text(x) {
      debug('^text@1^', this.constructor.name);
      return debug('^text@2^', this.isa.constructor.name);
    }
    ...
    jsidentifier(x) {
      debug('^jsidentifier@1^', this.constructor.name);
      debug('^jsidentifier@2^', this.isa.constructor.name);
      if (!this.isa.text(x)) {
        return false;
      }
    ...
    codepointid(x) {
      ...
      debug('^codepointid@1^', (ref = (ref1 = this.constructor) != null ? ref1.name : void 0) != null ? ref : '??????????????');
      debug('^codepointid@2^', (ref2 = (ref3 = this.isa) != null ? (ref4 = ref3.constructor) != null ? ref4.name : void 0 : void 0) != null ? ref2 : '??????????????');
  ...
  this.Types = Types = class Types {
    ...
    //---------------------------------------------------------------------------------------------------------
    _compile() {
      var i, len, method, otype, proto, ref, ref1, ref2, ref3, type;
      proto = {};
      this.isa = Object.create(proto);
      debug('^_compile@1^', (ref = (ref1 = this.isa) != null ? (ref2 = ref1.constructor) != null ? ref2.name : void 0 : void 0) != null ? ref : '????????????????????????????????????');
      this._isa_methods = [];
      ref3 = props.public_keys(Isa.prototype);
