(function() {
  'use strict';
  var All_of, Any_of, Intertype, Isa, Iterator, Optional, _Intertype, _types, debug, defaults, get_value, nothing, props;
  ...
  get_value = function(x) {
    if ((x instanceof All_of) || (x instanceof Any_of)) {
      return x.value;
    } else {
      return x;
    }
