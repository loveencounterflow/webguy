(function() {
  'use strict';
  var All_of, Any_of, Failure, Intertype, Isa, Iterator, Optional, Sentinel, _Intertype, _types, debug, defaults, get_value, props;
  ...
  Failure = class Failure extends Sentinel {
    get(r = null) {
      return r != null ? r : this.value/* TAINT is this special case needed? */;
    }
